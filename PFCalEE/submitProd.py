...
for et in enlist :
    ...
    if opt.nosubmit : os.system('echo bsub -o /dev/null -e /dev/null -q %s %s/runJob.sh'%(myqueue,outDir)) 
    else: os.system("bsub -o /dev/null -e /dev/null -q %s \'%s/runJob.sh\'"%(myqueue,outDir))
