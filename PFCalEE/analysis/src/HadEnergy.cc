...
void HadEnergy::bookHist(TFile *outputFile){
     ...
     lName.str("");
     lName << "p_EE_e" << genEn_;
     p_EE = new TH1F(lName.str().c_str(),"p_EE",1000,0,30000);

     lName.str("");
     lName << "p_EFHCAL_e" << genEn_;
     p_EFHCAL = new TH1F(lName.str().c_str(),"p_EFHCAL",1000,0,30000);

     lName.str("");
     lName << "p_EBHCAL_e" << genEn_;
     p_EBHCAL = new TH1F(lName.str().c_str(),"p_EBHCAL",1000,0,30000);
